...
public class UsersController : Controller
{
	...
	{
		var ClassEvm = UserRepo.Find(id);
		return View(ClassEvm);
	}

    [HttpPost]
	public ActionResult Create(Users klientas)
	{
		//do not allow creation of entity with 'asmensKodas' field matching existing one
		var match = UserRepo.Find(klientas.id);
    ...
    [HttpPost]
	public ActionResult Edit(int Asmens_kodas, Users klientas)
	{
		//form field validation passed?
		if (ModelState.IsValid)
		{
			UserRepo.Update(klientas);
