...
public class ManualTest {
    ...
    public static void executeTest() {
        ...
        Car car8Replacer = new Car("TRUCKDRIVER123 Laguna 2001 115900 7500");
    ...
    private static void executeCarMapTests(String[] carsIds, Car[] cars) {
        ...
        Ks.oun("Remove poru patikrinimas");
        Ks.oun("Removed car: " + carsMap.get(carsIds[2]));
        carsMap.remove(carsIds[2]);
        carsMap.println("");


        /*
        Ks.oun("Remove poru patikrinimas");
        Ks.oun("Removed car: " + carsMap.get(carsIds[1]));
        carsMap.remove(carsIds[1]);*/


        /*
        Car car8Replacer = new Car("TRUCKDRIVER123 Laguna 2001 115900 7500");

        Ks.oun("Replace poru patikrinimas");
        Ks.oun("Replaced car: " + carsMap.get(carsIds[1]));
        carsMap.replace(carsIds[1], carsMap.get(carsIds[1]), car8Replacer);

        */
        Car car3 = new Car("Toyota", "Corolla", 2001, 20000, 8500.8);
        Ks.oun("Has value");
        Ks.oun("Has Value: " + car3);
        Ks.oun(carsMap.containsValue(car3));
    ...
    private static void executeCarMapOaTests(String[] carsIds, Car[] cars) {
        ...
        Ks.oun("Remove poru patikrinimas");
        Ks.oun("Removed car: " + carsMapOa.get(carsIds[2]));
        carsMapOa.remove(carsIds[2]);
        carsMapOa.println("");
        ...
        Ks.oun("Replace poru patikrinimas");
        Ks.oun("Replaced car: " + carsMapOa.get(carsIds[1]));
        carsMapOa.replace(carsIds[1], carsMapOa.get(carsIds[1]), car8Replacer);
        carsMapOa.println("");
        ...
        Ks.oun("Has value");
        Ks.oun("Has Value: " + car3);
        Ks.oun(carsMapOa.containsValue(car3));
